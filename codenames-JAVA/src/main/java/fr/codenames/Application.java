...
//		test.cr√©erJoueur();
		...
		// R√âP√âTITION DU MENU (0 pour en sortir)
		do {
...
//						joueursup.setPseudo(scansup.nextLine());
			...
			case 4:
				...
				do {
					...
					case 2:// statistique joueur
						...
						System.out.println("Le joueur " + joueur1.getPseudo() + " a jouÈ " + joueur1.getNbrPartie()
								+ " parties et en a gagnÈ " + joueur1.getNbrVictoire() + ". Il a jouÈ MaitreEspion "
	...
	public static int menuJoueurs() {
		...
		System.out.println("2- CrÈer joueur");
	...
	public static int menuCartes() {
		...
		System.out.println("2- CrÈer Carte");
